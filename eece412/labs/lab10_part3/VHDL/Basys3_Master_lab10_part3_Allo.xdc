...
# set_property PACKAGE_PIN V16 [get_ports {vga_pixel_tick}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {vga_pixel_tick}]
# set_property PACKAGE_PIN W16 [get_ports {blank}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {blank}]
# set_property PACKAGE_PIN W17 [get_ports {comp_sync}]					
...
set_property PACKAGE_PIN U16 [get_ports {comp_sync}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {comp_sync}]
set_property PACKAGE_PIN E19 [get_ports {blank}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {blank}]
set_property PACKAGE_PIN U19 [get_ports {vga_pixel_tick}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {vga_pixel_tick}]

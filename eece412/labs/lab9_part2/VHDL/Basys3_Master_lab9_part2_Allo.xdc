...
set_property PACKAGE_PIN V16 [get_ports {ctrl1[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ctrl1[0]}]
set_property PACKAGE_PIN W16 [get_ports {ctrl1[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ctrl1[1]}]
set_property PACKAGE_PIN W17 [get_ports {ctrl2[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ctrl2[0]}]
set_property PACKAGE_PIN W15 [get_ports {ctrl2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ctrl2[1]}]

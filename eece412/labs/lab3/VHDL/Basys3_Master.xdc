...
# added a third switch for the third bit of the input ctrl signal
...
# # added a sixth LED for the sixth bit of the output a signal
# set_property PACKAGE_PIN U15 [get_ports {a[5]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {a[5]}]
# # added a seventh LED for the seventh bit of the output a signal
# set_property PACKAGE_PIN U14 [get_ports {a[6]}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {a[6]}]
# # added an eighth LED for the eighth bit of the output a signal
